...
function fail(message: string): never {
  console.error(`\nTROTW 2.1.013 validation failed: ${message}`)
  process.exit(1)
}
...
if (packageJson.version !== '2.1.13') fail('package.json is not version 2.1.13')
...
if (!releasePage.includes('TrotwoodHeader active="read"')) fail('published reading pages are missing the persistent Trotwood header')
...
console.log('TROTW 2.1.013 release validation passed.')
