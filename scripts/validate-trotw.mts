...
function fail(message: string): never {
  console.error(`\nTROTW 2.1.07 validation failed: ${message}`)
  process.exit(1)
}
...
if (packageJson.version !== '2.1.7') fail('package.json is not version 2.1.7')
...
console.log('TROTW 2.1.07 release validation passed.')
