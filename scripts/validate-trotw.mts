...
function fail(message: string): never {
  console.error(`\nTROTW 2.1.014 validation failed: ${message}`)
  process.exit(1)
}
...
if (packageJson.version !== '2.1.14') fail('package.json is not version 2.1.14')
...
console.log('TROTW 2.1.014 release validation passed.')
